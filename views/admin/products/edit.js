...
module.exports = ({ product, errors }) => {
  return layout({
    ...
    <div class="card1 px-1 py-4">
        <div class="card-body">
            <h2 class="card-title mb-3 text-center">Edit  Product</h2>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group py-3">
                         <input class="form-control " type="text" name="title" value="${product.title}" placeholder="Product Name"> 
                         </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <div class="input-group py-3"> <input class="form-control" type="text" value="${product.price}" name="price" placeholder="Product Price"> </div>
                    </div>
